...
def make_btn(parent, text, command, primary=False) -> tk.Label:
    ...
    # tk.Button ignores bg/fg on macOS due to native rendering.
    # tk.Label respects colours fully and behaves identically with bindings.
    b = tk.Label(
        parent, text=text,
        bg=bg, fg=fg,
